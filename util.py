...
def import_image(self):
    ...
    destination = Constants.des_image_prod
    ...
    return filename
    # if filename:
    #     name_file = os.path.basename(u"%s" % filename)
    #     self.adresse_name_file = u"%s/%s" % (destination, unicode(name_file))
    #     self.path_.setText(unicode(name_file))
