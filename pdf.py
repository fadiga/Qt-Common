...
from reportlab.platypus import (Table, Paragraph, Frame, PageTemplate, Spacer,
...
class PDFGenerator(Generator):
    ...
    def _render_section(self, section):
        element = Paragraph(u'<strong>' + unicode(section.text) + u'</strong>',
                            self.section_style)
    ...
    def _render_table(self, table):
        ...
        if table.title != None:
            ...
            tabstyle.append(('BOX', (0, 0), (-1, -1), 0.5, colors.red))
            tabstyle.append(('FONTSIZE', (0, 0), (-1, -1), 12))
            tabstyle.append(('INNERGRID', (-1, -1), (0, 0), 0.5, colors.blue))
        ...
        for row in table.rows:
            ...
            if j % 2 == 1:
                tabstyle.append(('BACKGROUND', (0, i), (-1, i),
        ...
        tabstyle.append(('FONTSIZE', (0, 0), (-1, -1), 12))
        tabstyle.append(('INNERGRID', (-1, -1), (0, 0), 0.5, colors.black))

        tabstyle.append(('BOX', (0, 0), (-1, -1), 0.5, colors.black))
